...
function Content() {
  // *Шаг 3. Вызываем хук useContext, в который передаем контекст, который был создан на первом шаге
  // При вызове хука useContext он вернет те данные, которые были переданы в value провайдера на втором шаге
